...
public class YahooAPI {
    ...
    public ArrayList search(String sw, String cid, String so,Integer count) throws Exception {
        String esw = URLEncode(sw);
        String ecid = URLEncode(cid);
        String eso = URLEncode(so);
        String URL = searchURL + "appid=" + apiID + "&query=" + esw + "&category_id=" + ecid + "&sort=" + eso + "&offset=" + count;
