...
/**
 * registrationconfirm.jspと対応するサーブレット フォーム入力された情報はここでセッションに格納される。
 *
 * @author guest1Day
 */
public class RegistrationConfirm extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (session.getAttribute("udb") == null || session.getAttribute("registration") == null 
                    && !(session.getAttribute("lp").equals("RegistrationConfirm"))) {
            ...
            session.setAttribute("lp", "RegistrationConfirm");
