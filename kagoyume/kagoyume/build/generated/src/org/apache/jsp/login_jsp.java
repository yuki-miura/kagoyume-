...
public final class login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    String loginchk = (String) request.getAttribute("loginchk");
    Helper h = Helper.getInstance();
    UserDataBeans udb = (UserDataBeans) session.getAttribute("udb");
    ArrayList<String> chkList = udb.loginChkproperties();
      ...
      out.write("\"><br><br>\n");
      out.write("            <input type=\"hidden\" name=\"loginchk\" value=\"");
      out.print(loginchk);
      out.write("\">\n");
      out.write("            <input type=\"submit\" value=\"ログイン\"><br><br>\n");
      out.write("        </form>\n");
