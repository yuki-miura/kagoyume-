...
public final class top_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("<!--機能や挑戦することとして挙げるならば\n");
      out.write("1　クッキーでログイン情報を保持する\n");
      out.write("    ログアウトページの実装　ここを経由させることでクッキーを反映させる\n");
      out.write("2　DB未接続時にエラーをキャッチする\n");
      out.write("    現状どのページでキャッチするのかわかっていない（nullで対処）\n");
      out.write("3　カート管理の判断条件をuserIDにする（現在はNameでユニークではない）\n");
      out.write("4　dogetやdopostに直接書き込む\n");
      out.write("-->\n");
    ...
    session.setAttribute("count", count);
      ...
      out.write("                    </div>\n");
      out.write("                    ");
      org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, "/ac.jsp", out, false);
      out.write("\n");
